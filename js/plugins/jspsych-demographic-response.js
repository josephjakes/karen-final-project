...
jsPsych.plugins["demographic-response"] = (function() {
    ...
    plugin.trial = function(display_element, trial) {
        ...
        function end_trial() {
			...
			//AustraliaBased_radios = document.getElementsByName("AustraliaBased");

            //var ii;
            //for (ii = 0; ii < AustraliaBased_radios.length; ii++) {
            //    if (AustraliaBased_radios[ii].checked) {p_AustraliaBased = AustraliaBased_radios[ii].value};
            //};
